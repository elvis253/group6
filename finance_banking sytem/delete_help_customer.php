    ...
    <div class="flex-container">
        ...
        if(empty($_POST['subject'])){
          echo "<h1 style='color:red'>No message selected</h1>";
            ...
            $delete="DELETE FROM grievance WHERE post_id =$subject";
         if($conn->query($delete)===TRUE){
            ...
            if ($result->num_rows > 0) {
                 ?>
                 <form method="post"><center><input type="submit" name="submit" value=delete style="color:green;width:70px;height:70px"></center>
