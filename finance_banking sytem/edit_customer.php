...
<body>
    <form class="add_customer_form" action="./edit_customer_action.php" method="post">
        ...
        <div class="flex-container">
            ...
            <div  class=container>
                <select name="branch">
                    ...
                    <option value="Busia" <?php if ($branch == 'Busia') {?> selected="selected" <?php }?>>Busia</option>
                    <option value="Mombasa" <?php if ($branch == 'Mombasa') {?> selected="selected" <?php }?>>Mombasa</option>
                    <option value="Kisumu" <?php if ($branch == 'Kisumu') {?> selected="selected" <?php }?>>Kisumu</option>
                    <option value="Eldoret" <?php if ($branch == 'Eldoret') {?> selected="selected" <?php }?>>Eldoret</option>
                    <option value="Nakuru" <?php if ($branch == 'Nakuru') {?> selected="selected" <?php }?>>Nakuru</option>
                </select>
            </div>
        </div>
        ...
        <div class="flex-container">
            <div  class=container>
                <label>PESA PIN(4 digit) :</b></label><br>
