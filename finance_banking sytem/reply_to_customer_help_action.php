...
<body>
    <div class="flex-container">
        <div class="flex-item">
            ...
            $sql0 = "INSERT INTO  adminreplies(cust_id,created,title,body)
            VALUES($id,NOW(),'$headline','$news_details')";
        ...
        <div class="flex-item">
            <a href="./reply_to_customer_help.php" class="button">REPLY AGAIN</a>
        </div>
