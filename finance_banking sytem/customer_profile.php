        ...
        <div class="flex-container">
            <div class=container>
                <label>Bank Branch :
                    <label id="info_label">
                        <?php
                            if ($branch == "Nairobi") {echo "Nairobi";}
                            elseif ($branch == "Kisumu") {echo "Kisumu";}
                            elseif ($branch == "Mombasa") {echo "Mombasa";}
                            elseif ($branch == "Eldoret") {echo "Eldoret";}
                            elseif ($branch == "Nakuru") {echo "Nakuru";}
                            elseif ($branch == "Busia") {echo "Busia";}
                        ?>
                    </label>
                </label>
            </div>
